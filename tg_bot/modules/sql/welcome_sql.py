...
DEFAULT_GOODBYE = "Надеюсь мы с тобой больше не увидимся, мой дорогой бывший друг *{fullname}*!"
...
class Welcome(BASE):
    ...
    def __repr__(self):
        return "<Чат {}, поприветствуем нового пользователя: {}>".format(self.chat_id, self.should_welcome)
