...
боты, стремящиеся обеспечить простое расширение плагина с помощью простого перетаскивания.
...
## Настройка бота (прочтите перед использованием!):Setting up the bot (Read this before trying to use!):
...
Был переведен на русский язык и были добавлены некоторые новые команды
